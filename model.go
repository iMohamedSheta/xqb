...
// 	// Handle JSON/JSONB data types first
// 	if isJSONType(fieldValue.Type()) {
// 		return setJSONFieldValue(fieldValue, dataValue)
// 	}
...
// // isJSONType checks if the field type should be treated as JSON
// func isJSONType(t reflect.Type) bool {
// 	// Check for []byte (commonly used for JSON/JSONB)
...
// 	// Check for map[string]any or map[string]interface{}
...
// // setJSONFieldValue handles JSON and JSONB field types
// func setJSONFieldValue(fieldValue reflect.Value, dataValue any) error {
// 	// Handle nil values
// 	if dataValue == nil {
// 		return nil
// 	}
...
// 	// Convert dataValue to JSON bytes based on its type
// 	switch v := dataValue.(type) {
// 	case []byte:
// 		// Already bytes (common for JSONB from PostgreSQL)
// 		jsonBytes = v
...
// 	default:
// 		// For map types, unmarshal the JSON
...
// 			mapPtr := reflect.New(fieldValue.Type())
...
// // ---------- isSQLNull check if type is sql nullable ----------
...
// // ---------- setSQLNull sets a SQL null value ----------
