...
func (d *PostgresDialect) compileFromClause(qb *types.QueryBuilderData) (string, []any, error) {
...
func (d *PostgresDialect) resolveTable(qb *types.QueryBuilderData, statement string, allowBindings bool) (string, []any, error) {
